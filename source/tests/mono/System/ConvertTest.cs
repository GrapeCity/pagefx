...
namespace MonoTests.System
{
    ...
    public class ConvertTest : Assertion
    {
        ...
        public void TestToDateTime()
        {
            ...
            //NOTE: Assertion below is version dependent. Fix later!!!
#if NOT_PFX
        ...
        public void TestConvertFromNull()
        {
            ...
            try
            {
                AssertEquals(a, false, Convert.ToBoolean(null as object));

                a = "#W2";
                AssertEquals(a, 0, Convert.ToByte(null as object));

                a = "#W3";
                AssertEquals(a, 0, Convert.ToChar(null as object));

                a = "#W4";
                AssertEquals(a, new DateTime(1, 1, 1, 0, 0, 0), Convert.ToDateTime(null as object));

                a = "#W5";
                AssertEquals(a, 0, Convert.ToDecimal(null as object));

                a = "#W6";
                AssertEquals(a, 0, Convert.ToDouble(null as object));

                a = "#W7";
                AssertEquals(a, 0, Convert.ToInt16(null as object));

                a = "#W8";
                AssertEquals(a, 0, Convert.ToInt32(null as object));

                a = "#W9";
                AssertEquals(a, 0, Convert.ToInt64(null as object));

                a = "#W10";
                AssertEquals(a, 0, Convert.ToSByte(null as object));

                a = "#W11";
                AssertEquals(a, 0, Convert.ToSingle(null as object));

                a = "#W12";
                AssertEquals(a, "", Convert.ToString(null as object));

                a = "#W13";
                AssertEquals(a, 0, Convert.ToUInt16(null as object));

                a = "#W14";
                AssertEquals(a, 0, Convert.ToUInt32(null as object));

                a = "#W15";
                AssertEquals(a, 0, Convert.ToUInt64(null as object));

                a = "#W16";
                AssertEquals(a, false, Convert.ToBoolean(null as string));

                a = "#W17";
                AssertEquals(a, 0, Convert.ToByte(null as string));
            }
            catch (Exception e)
            {
                Fail(a + ": " + e);
        ...
        [Test]
        public void TestTo_NullObjectFormatProvider()
        {
            object o = null;
        ...
        [Test]
        public void TestTo_NullStringFormatProvider()
        {
            string s = null;
            IFormatProvider fp = (IFormatProvider)new NumberFormatInfo();
            // signed
