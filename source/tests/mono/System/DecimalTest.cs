...
namespace MonoTests.System
{
    ...
    public class DecimalTest : Assertion
    {
        ...
        public void ToInt64()
        {
            ...
            {
                a = "Decimal.ToInt64";
                AssertEquals(a, 254, Decimal.ToInt64(d));

                a = "Convert.ToInt64";
                AssertEquals(a, 255, Convert.ToInt64(d));

                a = "IConvertible.ToInt64";
                AssertEquals(a, 255, (d as IConvertible).ToInt64(null));
            ...
            {
                Fail("Unexpected exception in " + a + " on " + d + ":\n" + e);
            }
        }

        [Test]
        public void ToInt64_pfx()
        {
            Decimal d = -254.9m;
            Int64 i = Decimal.ToInt64(d);
            Console.WriteLine(i);
            AssertEquals("-Decimal.ToInt64", -254, i);
        }
