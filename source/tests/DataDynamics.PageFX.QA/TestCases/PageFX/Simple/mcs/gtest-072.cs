...
class TestLog
{
    class MyTest
    {
        static void Test1()
        {
            ...
            log2.Add(DateTime.Today);
            log2.Add(DateTime.Today.AddHours(1));
        ...
        public static void TestPairLog()
        {
            ...
            log.Add(new Pair<DateTime, String>(DateTime.Today, "Tea leaves"));
            log.Add(new Pair<DateTime, String>(DateTime.Today.AddMinutes(2), "Hot water"));
            log.Add(new Pair<DateTime, String>(DateTime.Today.AddMinutes(7), "Ready"));
