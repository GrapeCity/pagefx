...
namespace DataDynamics.Compression.Checksums 
{
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="DataDynamics.Compression.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="DataDynamics.Compression.Zip.Compression.Streams.DeflaterOutputStream"/>
