...
namespace DataDynamics.PageFX.CLI.GAC
{
    ...
    /// </summary>
    [ComImport, Guid("582dac66-e678-449f-aba6-6faaec8a9394"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public interface IInstallReferenceItem
    {
        ...
        /// <returns></returns>
        [PreserveSig]
        int GetReference([MarshalAs(UnmanagedType.LPArray)] out FUSION_INSTALL_REFERENCE[] ppRefData, uint dwFlags,
                         IntPtr pvReserved);
    }
}