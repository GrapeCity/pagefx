...
namespace DataDynamics.PageFX.FLI
{
    partial class SwfCompiler : IDisposable
    {
        ...
        {
            get { return Hex.ToString(_options.BackgroundColor); }
        }
        ...
        void GenerateApplicationFrame()
        {
            ...
            {
                var rootName = IsMxApplication ? _typeMxApp.FullName : g.RootSprite.FullName;
            ...
            get
            {
                ...
                if (_typeMxAppFind)
                {
                    ...
                    if (n > 0)
                    {
                        ...
                        {
                            _typeMxApp = Algorithms.Find(apps, TypeHelper.IsRootSprite);
                            if (_typeMxApp == null)
        ...
        IType _typeMxApp;
        bool _typeMxAppFind = true;

        /// <summary>
        /// Auto detects whether translated assembly is MX application.
        /// </summary>
        ...
        void GenerateMxSystemManagerFrame()
        {
            if (IsSwc) return;
