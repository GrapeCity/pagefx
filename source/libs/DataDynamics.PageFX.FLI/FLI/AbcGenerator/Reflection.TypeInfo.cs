    ...
    partial class AbcGenerator
    {
        ...
        bool IsMemberwiseCloneCompiled
        {
            get 
            {
                ...
                var m = MethodHelper.Find(SystemTypes.Object, "MemberwiseClone", 0);
                if (m == null)
        ...
        AbcMethod DefineEnumInfoInitializer(IType type)
        {
            ...
            return enumInstance.DefineStaticMethod(
                ...
                delegate(AbcCode code)
                {
                    ...
                    if (Attrs.Has(type, "System.FlagsAttribute"))
                    {
        ...
        #region GetTypeKind
        static int GetTypeKind(IType type)
        {
            ...
            switch (type.TypeKind)
            {
                ...
                case TypeKind.Struct:
                    {
                        if (type.Name == "System.DBNull")
                            return typeCodeOffset + (int)TypeCode.DBNull;

                        if (type.Name == "System.DateTime")
        ...
        void InitTypeInfo(AbcCode code, IType type, int typeId)
        {
            ...
            code.GetLocal(varType);
            code.PushString(TypeHelper.GetPartialTypeName(type));
