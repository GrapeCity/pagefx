    ...
    public sealed class Conversions
    {
        ...
        public static object ChangeType(object Expression, Type TargetType)
        {
            ...
            if (((ConversionResolution.ClassifyPredefinedConversion(TargetType, type) == ConversionResolution.ConversionClass.None) && (Symbols.IsClassOrValueType(type) || Symbols.IsClassOrValueType(TargetType))) && (!Symbols.IsIntrinsicType(type) || !Symbols.IsIntrinsicType(TargetType)))
            {
                ...
                ConversionResolution.ConversionClass class2 = ConversionResolution.ClassifyUserDefinedConversion(TargetType, type, ref operatorMethod);
                ...
                {
                    throw new InvalidCastException(Utils.GetResourceString("AmbiguousCast2", new string[] { Utils.VBFriendlyName(type), Utils.VBFriendlyName(TargetType) }));
                }
            }
            throw new InvalidCastException(Utils.GetResourceString("InvalidCast_FromTo", new string[] { Utils.VBFriendlyName(type), Utils.VBFriendlyName(TargetType) }));
        }
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (byte) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (double) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (int) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (long) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (sbyte) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (float) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (uint) (convertible.ToBoolean(null) ? 1 : 0);
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        if (Value is bool)
                        {
                            return (ulong) ((long) (((bool) Value) ? 1 : 0));
                        }
                        return (ulong) ((long) (convertible.ToBoolean(null) ? 1 : 0));
            ...
            if (convertible != null)
            {
                switch (convertible.GetTypeCode())
                {
                    case TypeCode.Boolean:
                        ...
                        return (ushort) (convertible.ToBoolean(null) ? 1 : 0);
        ...
        {
            CultureInfo cultureInfo = Utils.GetCultureInfo();
            return MSCorLibWorkarounds.DateTimeTryParse(Utils.ToHalfwidthNumbers(Value, cultureInfo), cultureInfo, DateTimeStyles.NoCurrentDateDefault | DateTimeStyles.AllowWhiteSpaces, ref Result);
        }
        ...
        internal static bool TryParseDouble(string Value, ref double Result)
        {
            ...
            {
                return MSCorLibWorkarounds.DoubleTryParse(Value, NumberStyles.Any, normalizedNumberFormat, ref Result);
            }
            try
            {
            ...
            catch (FormatException)
            {
                try
                {
                    flag = MSCorLibWorkarounds.DoubleTryParse(Value, NumberStyles.Any, numberFormat, ref Result);
                }
