namespace Microsoft.VisualBasic.CompilerServices
{
    ...
    internal class Symbols
    {
        ...
        internal static bool IsShadows(MethodBase Method)
        {
            ...
            if ((Method.IsVirtual && ((Method.Attributes & MethodAttributes.VtableLayoutMask) == MethodAttributes.ReuseSlot)) && ((((MethodInfo) Method).GetBaseDefinition().Attributes & MethodAttributes.VtableLayoutMask) == MethodAttributes.ReuseSlot))
            {
                return false;
            }
            return true;
        ...
        internal sealed class Container
        {
            ...
            private MemberInfo[] LookupDefaultMembers(ref string DefaultMemberName)
            {
                ...
                if (name != null)
                {
                    ...
                    if (array != null)
                    {
                        ...
                        if (array.Length > 1)
                        {
                            Array.Sort<MemberInfo>(array, InheritanceSorter.Instance);
                        }
                        return array;
                    }
                }
            ...
            class InheritanceSorter : IComparer<MemberInfo>
            {
                ...
                public int Compare(MemberInfo Left, MemberInfo Right)
                {
                    Type declaringType = Left.DeclaringType;
                    Type c = Right.DeclaringType;
                    if (declaringType == c)
                    {
                        return 0;
                    }
...
#else
                        m_RawDeclaringType = declaringType;
#endif
                    }
...
#else
                            this.m_RawParametersFromType = ((MethodBase)m_Item).GetParameters();
#endif
                        }
                        else
                        {
