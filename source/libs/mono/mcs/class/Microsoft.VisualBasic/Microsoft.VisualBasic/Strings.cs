    ...
    public sealed class Strings
    {
        ...
        public static int Asc(char String)
        {
            ...
            try
            {
                ...
                int num3 = fileIOEncoding.GetBytes(chars, 0, 1, bytes, 0);
                num = bytes[0];
            }
        ...
        public static string[] Filter(object[] Source, string Match, [Optional, DefaultParameterValue(true)] bool Include, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
        ...
        public static string[] Filter(string[] Source, string Match,
            [Optional, DefaultParameterValue(true)] bool Include,
            [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
            string[] strArray;
            try
            {
        ...
        public static string Format(object Expression, [Optional, DefaultParameterValue("")] string Style)
        {
            string str;
            try
            {
        ...
        public static string FormatCurrency(object Expression, [Optional, DefaultParameterValue(-1)] int NumDigitsAfterDecimal,
            [Optional, DefaultParameterValue(TriState.UseDefault)] TriState IncludeLeadingDigit,
            [Optional, DefaultParameterValue(TriState.UseDefault)] TriState UseParensForNegativeNumbers,
            [Optional, DefaultParameterValue(TriState.UseDefault)] TriState GroupDigits)
        {
            string str;
            IFormatProvider formatProvider = null;
            try
        ...
        public static string FormatDateTime(DateTime Expression,
            [Optional, DefaultParameterValue(DateFormat.GeneralDate)] DateFormat NamedFormat)
        {
            string str;
            try
            {
            ...
            switch (length)
            {
                ...
                case 6:
                {
                    ...
                    if ((ch2 != 'y') && (ch2 != 'Y'))
                    {
                        ...
                        ReturnValue = (-(Conversions.ToBoolean(Expression) ? 1 : 0)).ToString(CachedOnOffFormatStyle, null);
                        return true;
                    }
                    ...
                    ReturnValue = (-(Conversions.ToBoolean(Expression) ? 1 : 0)).ToString(CachedYesNoFormatStyle, null);
                    return true;
                }
                case 7:
                {
                ...
                case 10:
                    switch (Style[6])
                    {
                        ...
                        case 'a':
                            ...
                            ReturnValue = (-(Conversions.ToBoolean(Expression) ? 1 : 0)).ToString(CachedTrueFalseFormatStyle, null);
                            return true;
        ...
        public static string FormatNumber(object Expression,
            [Optional, DefaultParameterValue(-1)] int NumDigitsAfterDecimal,
            [Optional, DefaultParameterValue(TriState.UseDefault)] TriState IncludeLeadingDigit,
            [Optional, DefaultParameterValue(TriState.UseDefault)] TriState UseParensForNegativeNumbers,
            [Optional, DefaultParameterValue(TriState.UseDefault)] TriState GroupDigits)
        {
        ...
        public static int InStr(string String1, string String2, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
        ...
        public static int InStr(int Start, string String1, string String2, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
            if (Start < 1)
            {
        ...
        public static int InStrRev(string StringCheck, string StringMatch, [Optional, DefaultParameterValue(-1)] int Start, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
            int num;
            try
            {
        ...
        public static string Join(object[] SourceArray, [Optional, DefaultParameterValue(" ")] string Delimiter)
        {
        ...
        public static string Join(string[] SourceArray, [Optional, DefaultParameterValue(" ")] string Delimiter)
        {
            string str;
            try
            {
        ...
        public static string Replace(string Expression, string Find, string Replacement, [Optional, DefaultParameterValue(1)] int Start, [Optional, DefaultParameterValue(-1)] int Count, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
            string str;
            try
            {
        ...
        public static string[] Split(string Expression, [Optional, DefaultParameterValue(" ")] string Delimiter, [Optional, DefaultParameterValue(-1)] int Limit, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
            string[] strArray;
            try
            {
        ...
        public static int StrComp(string String1, string String2, [Optional, DefaultParameterValue(CompareMethod.Binary), OptionCompare] CompareMethod Compare)
        {
            int num;
            try
            {
