    ...
    class NumberFormatter
    {
        ...
        public static string NumberToString(string format, sbyte value, NumberFormatInfo nfi)
        {
            ...
            if (!custom && (specifier == 'x' || specifier == 'X'))
                return FormatHexadecimal((uint)value & 0xff, precision, specifier == 'X');
        ...
        public static string NumberToString(string format, ushort value, NumberFormatInfo nfi)
        {
            ...
            ParseBasicFormat(format, out specifier, out precision, out custom);
            if (!custom && (specifier == 'x' || specifier == 'X'))
                return FormatHexadecimal((uint)value & 0xFFFF, true, 2, precision, specifier == 'X');
            return NumberToString(format, new NumberStore(value), nfi, specifier, precision, custom);
        }
        ...
        public static string NumberToString(string format, short value, NumberFormatInfo nfi)
        {
            ...
            ParseBasicFormat(format, out specifier, out precision, out custom);
            if (!custom && (specifier == 'x' || specifier == 'X'))
                return FormatHexadecimal((uint)value & 0xFFFF, precision, specifier == 'X');
            return NumberToString(format, new NumberStore(value), nfi, specifier, precision, custom);
        }
        ...
        public static string NumberToString(string format, uint value, NumberFormatInfo nfi)
        {
            ...
            ParseBasicFormat(format, out specifier, out precision, out custom);
            if (!custom && (specifier == 'x' || specifier == 'X'))
                return FormatHexadecimal(value, precision, specifier == 'X');
            return NumberToString(format, new NumberStore(value), nfi, specifier, precision, custom);
        }
        ...
        public static string NumberToString(string format, int value, NumberFormatInfo nfi)
        {
            ...
            ParseBasicFormat(format, out specifier, out precision, out custom);
            if (!custom && (specifier == 'x' || specifier == 'X'))
                return FormatHexadecimal((uint)value, precision, specifier == 'X');
            return NumberToString(format, new NumberStore(value), nfi, specifier, precision, custom);
        }
        ...
        {
            if (ns.ZeroOnly) return "0";

            if (precision <= 0)
                precision = ns.DefaultPrecision;
        ...
        static string FormatHexadecimal(uint value, int precision, bool upper)
        {
            char[] digits = (upper ? digitUpperTable : digitLowerTable);
            string str = "";
        ...
        {
            readonly bool _NaN;
            readonly bool _infinity;
            bool _positive;
            int _decPointPos;
            readonly int _defPrecision;
            readonly int _defMaxPrecision;
            readonly int _defByteSize;
            byte[] _digits;

            #region Bases
            private static readonly uint[] UIntList = new uint[]
                {
                    1,
                    10,
                    100,
            ...
            #region GetMaxIndex
            private static int GetMaxIndex(uint v)
            {
                if (v < 10u) return 0;
                if (v < 100u) return 1;
                if (v < 1000u) return 2;
                if (v < 10000u) return 3;
                if (v < 100000u) return 4;
                if (v < 1000000u) return 5;
                if (v < 10000000u) return 6;
                if (v < 100000000u) return 7;
                if (v < 1000000000u) return 8;
                return 9;
            }
            ...
            private void InitDigits(uint value)
            {
            ...
            private void InitDigits(ulong value)
            {
                int i = GetMaxIndex(value);
                int j = 0;
