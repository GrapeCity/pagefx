...
namespace flash.net
{
    ...
    public class XMLSocket : flash.events.EventDispatcher
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern XMLSocket(Avm.String arg0, int arg1);

        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern XMLSocket(Avm.String arg0);
        ...
        /// operation fails.
        /// </summary>
        /// <param name="arg0">An XML object or other data to transmit to the server.</param>
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void send(object arg0);
