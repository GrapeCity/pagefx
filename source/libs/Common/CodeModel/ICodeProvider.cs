...
namespace DataDynamics.PageFX.Common.CodeModel
{
    ...
    public interface ICodeProvider
    {
	    ...
	    IEnumerable<IInstruction> DeclareVariable(IVariable v);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadConstant(object value);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadVariable(IVariable v);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadArgument(IParameter p);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadField(IField field);

        IEnumerable<IInstruction> StoreThis();

	    /// <summary>
	    /// Returns code to load "this" onto the stack.
	    /// </summary>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadThis();

	    /// <summary>
	    /// Returns code to load "base" onto the stack.
	    /// </summary>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadBase();
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadStaticInstance(IType type);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> StoreVariable(IVariable v);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> StoreArgument(IParameter p);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> StoreField(IField field);
        #endregion
	    ...
	    IEnumerable<IInstruction> GetThisPtr();
	    ...
	    /// <returns>Array of instructions (code) to perform the operation.</returns>
	    IEnumerable<IInstruction> GetVarPtr(IVariable v);
	    ...
	    /// <returns>Array of instructions (code) to perform the operation.</returns>
	    IEnumerable<IInstruction> GetArgPtr(IParameter p);
	    ...
	    /// <returns>Array of instructions (code) to perform the operation.</returns>
	    IEnumerable<IInstruction> GetFieldPtr(IField field);
	    ...
	    /// <returns>Array of instructions (code) to perform the operation.</returns>
	    IEnumerable<IInstruction> GetElemPtr(IType elemType);
	    ...
	    /// <returns>Array of instructions (code) to perform the operation.</returns>
	    IEnumerable<IInstruction> LoadIndirect(IType valueType);
	    ...
	    /// <returns>Array of instructions (code) to perform the operation.</returns>
	    IEnumerable<IInstruction> StoreIndirect(IType valueType);
        #endregion
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> SetTempVar(out int var, bool keepStackState);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> GetTempVar(int var);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> KillTempVar(int var);
        #endregion
	    ...
	    IEnumerable<IInstruction> Branch(BranchOperator op, IType left, IType right);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Return(bool isvoid);
	    ...
	    /// </summary>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> BeginTry();
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> EndTry(bool generateExit, out IInstruction jump);
	    ...
	    /// <returns></returns>
	    IEnumerable<IInstruction> BeginCatch(ISehHandlerBlock handlerBlock);
	    ...
	    /// <param name="jump"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> EndCatch(ISehHandlerBlock block, bool isLast, bool generateExit, out IInstruction jump);
	    ...
	    /// <param name="block"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> BeginFinally(ISehHandlerBlock block);

        /// <summary>
        /// 
        /// </summary>
        /// <returns>code to perform given operation</returns>
		IEnumerable<IInstruction> EndFinally(ISehHandlerBlock block);
	    ...
	    /// <param name="block"></param>
	    /// <returns></returns>
	    IEnumerable<IInstruction> BeginFault(ISehHandlerBlock block);

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
		IEnumerable<IInstruction> EndFault(ISehHandlerBlock block);

	    /// <summary>
	    /// Returns code to throw value onto the stack.
	    /// </summary>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Throw();

        /// <summary>
        /// Returns code to rethrow exception catched within current exception handler block.
        /// </summary>
        /// <returns>code to perform given operation</returns>
		IEnumerable<IInstruction> Rethrow(ISehBlock block);

	    IEnumerable<IInstruction> ThrowTypeLoadException(string message);
        #endregion
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Op(BinaryOperator op, IType left, IType right, IType result, bool checkOverflow);
	    ...
	    /// <param name="checkOverflow"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Op(UnaryOperator op, IType type, bool checkOverflow);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> BeginCall(IMethod method);
	    ...
	    /// <param name="method"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> EndCall(IMethod method);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadReceiver(IMethod method, bool newobj);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> CallMethod(IType receiverType, IMethod method, CallFlags flags);
	    ...
	    /// <param name="type"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> InitObject(IType type);
	    ...
	    /// <param name="type"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> CopyValue(IType type);
	    ...
	    /// <param name="method"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> LoadFunction(IMethod method);
	    ...
	    /// <param name="method"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> InvokeDelegate(IMethod method);
	    ...
	    /// <param name="type"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> As(IType type);
	    ...
	    /// <param name="checkOverflow"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Cast(IType source, IType target, bool checkOverflow);

        IEnumerable<IInstruction> BoxPrimitive(IType type);
	    ...
	    /// <param name="type"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Box(IType type);
	    ...
	    /// <param name="type"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> Unbox(IType type);
	    ...
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> NewArray(IType elemType);
	    ...
	    /// <param name="elemType"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> SetArrayElem(IType elemType);
	    ...
	    /// <param name="elemType"></param>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> GetArrayElem(IType elemType);

	    /// <summary>
	    /// 
	    /// </summary>
	    /// <returns>code to perform given operation</returns>
	    IEnumerable<IInstruction> GetArrayLength();
	    ...
	    /// </summary>
	    /// <returns></returns>
	    IEnumerable<IInstruction> DebuggerBreak();
	    ...
	    /// <returns></returns>
	    IEnumerable<IInstruction> DebugFile(string file);
	    ...
	    /// <returns></returns>
	    IEnumerable<IInstruction> DebugLine(int line);
	    ...
	    /// <param name="type"></param>
	    /// <returns></returns>
	    IEnumerable<IInstruction> TypeOf(IType type);
	    ...
	    /// <param name="type"></param>
	    /// <returns></returns>
	    IEnumerable<IInstruction> SizeOf(IType type);
        ...
        IEnumerable<IInstruction> CopyToThis(IType valueType);
