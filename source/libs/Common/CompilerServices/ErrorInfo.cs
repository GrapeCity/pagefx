...
namespace DataDynamics.PageFX.Common.CompilerServices
{
    public sealed class ErrorInfo
    {
        ...
        public ErrorInfo(string code, string format, bool warn)
        {
        ...
        public ErrorInfo(string code, string format)
            : this(code, format, false)
        {
        }

        internal ErrorInfo(int id, string format, bool warn)
            : this(FormatCode(id), format, warn)
        {
        }

        internal ErrorInfo(int id, string format)
