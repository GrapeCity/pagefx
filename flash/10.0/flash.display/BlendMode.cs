...
namespace flash.display
{
    ...
    /// The blendMode property of the flash.display.DisplayObject class. The blendMode parameter of the draw() method of the
    ...
    public class BlendMode : Avm.Object
    {
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String ERASE;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String ALPHA;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String SUBTRACT;

        /// <summary>Inverts the background.</summary>
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String INVERT;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String LIGHTEN;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String MULTIPLY;

        [PageFX.ABC]
        [PageFX.FP10]
        public static Avm.String SHADER;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String DARKEN;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String HARDLIGHT;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String SCREEN;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String OVERLAY;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String LAYER;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public static Avm.String DIFFERENCE;

        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern BlendMode();
    }
}
