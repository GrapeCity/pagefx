...
namespace flash.printing
{
    ...
    public class PrintJob : flash.events.EventDispatcher
    {
        ...
        /// </summary>
        /// <param name="arg0">The instance name of the Sprite to print.</param>
        /// <param name="arg1">
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void addPage(flash.display.Sprite arg0, flash.geom.Rectangle arg1, PrintJobOptions arg2, int arg3);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void addPage(flash.display.Sprite arg0, flash.geom.Rectangle arg1, PrintJobOptions arg2);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void addPage(flash.display.Sprite arg0, flash.geom.Rectangle arg1);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void addPage(flash.display.Sprite arg0);
