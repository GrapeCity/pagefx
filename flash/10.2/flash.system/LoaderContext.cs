...
namespace flash.system
{
    ...
    public class LoaderContext : Avm.Object
    {
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public flash.system.ApplicationDomain applicationDomain;
        ...
        [PageFX.ABC]
        [PageFX.FP9]
        public flash.system.SecurityDomain securityDomain;
        ...
        [PageFX.ABC]
        [PageFX.FP("10.2")]
        public flash.display.DisplayObjectContainer requestedContentParent;
        ...
        public extern virtual bool allowLoadBytesCodeExecution
        {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern LoaderContext(bool checkPolicyFile, flash.system.ApplicationDomain applicationDomain, flash.system.SecurityDomain securityDomain);

        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern LoaderContext(bool checkPolicyFile, flash.system.ApplicationDomain applicationDomain);

        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern LoaderContext(bool checkPolicyFile);
