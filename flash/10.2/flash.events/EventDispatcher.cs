...
namespace flash.events
{
    ...
    public partial class EventDispatcher : Avm.Object, flash.events.IEventDispatcher
    {
        ...
        public event flash.events.EventHandler activate
        {
            add { }
            remove { }
        }
        ...
        public extern EventDispatcher(flash.events.IEventDispatcher target);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void addEventListener(Avm.String type, Avm.Function listener, bool useCapture, int priority, bool useWeakReference);

        [PageFX.AbcInstanceTrait(2)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void addEventListener(Avm.String type, Avm.Function listener, bool useCapture, int priority);

        [PageFX.AbcInstanceTrait(2)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void addEventListener(Avm.String type, Avm.Function listener, bool useCapture);

        [PageFX.AbcInstanceTrait(2)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void addEventListener(Avm.String type, Avm.Function listener);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void removeEventListener(Avm.String type, Avm.Function listener, bool useCapture);

        [PageFX.AbcInstanceTrait(3)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void removeEventListener(Avm.String type, Avm.Function listener);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual bool dispatchEvent(flash.events.Event @event);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual bool hasEventListener(Avm.String type);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual bool willTrigger(Avm.String type);
    }
}
