...
namespace flash.text
{
    ...
    public partial class StyleSheet : flash.events.EventDispatcher
    {
        ...
        /// null is returned.
        /// </summary>
        /// <param name="styleName">A string that specifies the name of the style to retrieve.</param>
        /// <returns>An object.</returns>
        [PageFX.AbcInstanceTrait(0)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual object getStyle(Avm.String styleName);
        ...
        /// </summary>
        /// <param name="styleName">A string that specifies the name of the style to add to the style sheet.</param>
        /// <param name="styleObject">An object that describes the style, or null.</param>
        [PageFX.AbcInstanceTrait(1)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void setStyle(Avm.String styleName, object styleObject);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual flash.text.TextFormat transform(object formatObject);
        ...
        /// </summary>
        /// <param name="CSSText">The CSS text to parse (a string).</param>
        [PageFX.AbcInstanceTrait(5)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void parseCSS(Avm.String CSSText);
    }
}
