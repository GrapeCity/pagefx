...
namespace flash.text
{
    ...
    public partial class TextSnapshot : Avm.Object
    {
        ...
        /// </summary>
        /// <param name="beginIndex">Specifies the starting point to search for the specified text.</param>
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual int findText(int beginIndex, Avm.String textToFind, bool caseSensitive);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual bool getSelected(int beginIndex, int endIndex);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual Avm.String getSelectedText(bool includeLineEndings);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual Avm.String getText(int beginIndex, int endIndex, bool includeLineEndings);

        [PageFX.AbcInstanceTrait(4)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern Avm.String getText(int beginIndex, int endIndex);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual Avm.Array getTextRunInfo(int beginIndex, int endIndex);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual double hitTestTextNearPos(double x, double y, double maxDistance);

        [PageFX.AbcInstanceTrait(6)]
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern double hitTestTextNearPos(double x, double y);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void setSelectColor(uint hexColor);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void setSelected(int beginIndex, int endIndex, bool select);
    }
}
