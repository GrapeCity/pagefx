...
namespace MonoTests.System
{
	...
	public class BitConverterTest
	{
		...
		private void PrivateTestSingle (float v1)
		{
			...
			Assert.IsTrue (Math.Abs(v1 - v2) <= 0.001f, "#A2");

			b.CopyTo (larger, 1);
			v2 = BitConverter.ToSingle (larger, 1);
            Assert.IsTrue(Math.Abs(v1 - v2) <= 0.001f, "#A3");
...
#endif
                //NOTE: This assert is version dependent.
		...
		private void PrivateTestInt32 (int v1)
		{
            ...
            //Console.WriteLine("{0:X2}", b[0]);
            //Console.WriteLine("{0:X2}", b[1]);
            //Console.WriteLine("{0:X2}", b[2]);
            //Console.WriteLine("{0:X2}", b[3]);
        ...
        //NOTE: This test is version dependent.
#if NOT_PFX
		[Test]
