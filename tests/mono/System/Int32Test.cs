...
namespace MonoTests.System
{
    ...
    public class Int32Test : Assertion
    {
        ...
        public void TestParse()
        {
            ...
            //NOTE: Double formatting is not yet implemented
#if NOT_PFX
            try
            {
        ...
        public void TestCustomToString()
        {
            ...
            AssertEquals("00000", "00123", i.ToString("00000"));
            AssertEquals("####", "123", i.ToString("####"));
            AssertEquals("0###", "0123", i.ToString("0###"));
            AssertEquals("#0###", "0123", i.ToString("#0###"));
            AssertEquals("0#0###", "000123", i.ToString("0#0###"));
        }
