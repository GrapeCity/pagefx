...
namespace MonoTests.System
{
 ...
 double.Epsilon;
        ...
        //NOTE: Long is not supported yet
#if NOT_PFX
        [Test]
        ...
        */
        ...
        public void TestIEEERemainder()
        {
            ...
            //NOTE: Int64 is not supported yet.
#if NOT_PFX
        ...
        public void TestLog2()
        {
            ...
            Assert.IsTrue((Math.Abs(a - b) <= 1e-14), a + " != " + b + " because diff is " + Math.Abs(a - b));
            Assert.IsTrue(double.IsNaN(Math.Log(-1, y)), "Math.Log(-1, y)");
            Assert.IsTrue(double.IsNaN(Math.Log(double.NaN, y)), "Math.Log(double.NaN, y)");
            Assert.IsTrue(double.IsNaN(Math.Log(x, double.NaN)), "Math.Log(x, double.NaN)");
            Assert.IsTrue(double.IsNaN(Math.Log(double.NegativeInfinity, y)), "Math.Log(double.NegativeInfinity, y)");
            Assert.IsTrue(double.IsNaN(Math.Log(x, double.NegativeInfinity)), "Math.Log(x, double.NegativeInfinity)");
            Assert.IsTrue(double.IsNaN(Math.Log(double.PositiveInfinity, double.PositiveInfinity)), "Math.Log(double.PositiveInfinity, double.PositiveInfinity)");

            // MS docs say this should be PositiveInfinity
            Assert.IsTrue(Math.Log(0, y) == double.NegativeInfinity, "Math.Log(0, y) == double.NegativeInfinity");
            Assert.IsTrue(Math.Log(double.PositiveInfinity, y) == double.PositiveInfinity, "Math.Log(double.PositiveInfinity, y) == double.PositiveInfinity");
#if NOT_MSCLR
            Assert.IsTrue(Math.Log(x, double.PositiveInfinity) == 0, "Math.Log(x, double.PositiveInfinity) == 0");
#endif
        }
        ...
        //NOTE: ULong is not supported yet.
#if NOT_PFX
        [Test]
