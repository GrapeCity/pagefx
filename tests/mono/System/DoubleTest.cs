...
namespace MonoTests.System
{
    ...
    public class DoubleTest
    {
        ...
        private double[] double_values = 
        {
            ...
            -221.3233, //8
#if NOT_PFX
			1.7976931348623157e308, //9
            1.7976931348623157e308, //10
            -1.7976931348623157e308, //11
			4.9406564584124650e-324, //12
#endif
			6.28318530717958647692528676655900577, //13
			1e-05, //14
			0, //15
		};
        ...
        public void GetReady()
        {
            ...
            string_values = new string[15 - 4];
            int i = 0;
            string_values[i++] = "1"; //0
            string_values[i++] = sep + "1"; //1
            string_values[i++] = "1" + sep + "1"; //2
            string_values[i++] = "-12"; //3
            string_values[i++] = "44" + sep + "444432"; //4
            string_values[i++] = sep + "000021121"; //5
            string_values[i++] = "   " + sep + "00001"; //6
            string_values[i++] = "  " + sep + "223    "; //7
            string_values[i++] = "         -221" + sep + "3233"; //8
#if NOT_PFX
            string_values[i++] = " 1" + sep + "7976931348623157e308 "; //9
            string_values[i++] = "+1" + sep + "7976931348623157E308"; //10
            string_values[i++] = "-1" + sep + "7976931348623157e308"; //11
            string_values[i++] = "4" + sep + "9406564584124650e-324"; //12
#endif
            string_values[i++] = "6" + sep + "28318530717958647692528676655900577"; //13
            string_values[i++] = "1e-05"; //14
        }
        ...
        public void Parse()
        {
            ...
            for (i = 0; i < string_values_fail.Length; ++i)
            {
                try
                {
                    ...
                    Assertion.Fail("#H1[" + i + "]: " + string_values_fail[i]);
                }
                catch (FormatException ex)
                {
        ...
        public void ToString_Defaults()
        {
            ...
            SetCulture(new CultureInfo("nl-BE"));
            try
            {
                Double i = 254.9d;
