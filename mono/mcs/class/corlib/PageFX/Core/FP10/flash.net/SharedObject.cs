...
namespace flash.net
{
    ...
    public class SharedObject : flash.events.EventDispatcher
    {
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual Avm.String flush(int arg0);
        ...
        /// </summary>
        /// <param name="arg0">The name of the property that has changed.</param>
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void setDirty(Avm.String arg0);
        ...
        /// </param>
        /// <param name="arg1">(default = null)</param>
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void connect(NetConnection arg0, Avm.String arg1);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void connect(NetConnection arg0);
        ...
        /// </summary>
        /// <param name="arg0">The name of the property in the shared object.</param>
        /// <param name="arg1">(default = null)  The value of the property (an ActionScript object), or null to delete the property.</param>
        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual void setProperty(Avm.String arg0, object arg1);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern void setProperty(Avm.String arg0);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static int getDiskUsage(Avm.String arg0);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getLocal(Avm.String arg0, Avm.String arg1, bool arg2);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getLocal(Avm.String arg0, Avm.String arg1);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getLocal(Avm.String arg0);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static int deleteAll(Avm.String arg0);
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getRemote(Avm.String arg0, Avm.String arg1, object arg2, bool arg3);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getRemote(Avm.String arg0, Avm.String arg1, object arg2);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getRemote(Avm.String arg0, Avm.String arg1);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static SharedObject getRemote(Avm.String arg0);
    }
}
