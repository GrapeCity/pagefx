...
namespace flash.media
{
    ...
    {
        public extern static SoundTransform soundTransform
        {
            [PageFX.ABC]
            [PageFX.FP9]
        ...
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static void computeSpectrum(flash.utils.ByteArray arg0, bool arg1, int arg2);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static void computeSpectrum(flash.utils.ByteArray arg0, bool arg1);

        [PageFX.ABC]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern static void computeSpectrum(flash.utils.ByteArray arg0);
