...
namespace Avm
{
    ...
    public class Function : Object
    {
        ...
        /// <param name="arg1">(default = null)  An array whose elements are passed to the function as parameters.</param>
        [PageFX.ABC]
        [PageFX.QName("apply", "http://adobe.com/AS3/2006/builtin", "public")]
        [PageFX.FP9]
        [MethodImpl(MethodImplOptions.InternalCall)]
        public extern virtual object apply(object thisObject, object arg1);
