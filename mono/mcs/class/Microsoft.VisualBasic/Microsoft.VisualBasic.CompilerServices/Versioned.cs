namespace Microsoft.VisualBasic.CompilerServices
{
    ...
    public sealed class Versioned
    {
        ...
        {
            switch (Strings.Trim(VbName).ToUpper(CultureInfo.InvariantCulture))
            {
                case "BOOLEAN":
        ...
        public static string TypeName(object Expression)
        {
            ...
            return Utils.VBFriendlyNameOfType(Expression.GetType(), false);
        }

        public static string VbTypeName(string SystemName)
        {
            SystemName = Strings.Trim(SystemName).ToUpper(CultureInfo.InvariantCulture);
