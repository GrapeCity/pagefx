namespace Microsoft.VisualBasic
{
    ...
    public sealed class DateAndTime
    {
        ...
        public static string MonthName(int Month, [Optional, DefaultParameterValue(false)] bool Abbreviate)
        {
        ...
        public static string TimeString
        {
            get
            {
                DateTime time2 = new DateTime(DateTime.Now.TimeOfDay.Ticks);
                return time2.ToString("HH:mm:ss", Utils.GetInvariantCultureInfo());
            }
        }
